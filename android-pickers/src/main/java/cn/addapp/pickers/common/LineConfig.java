...
public class LineConfig {
    ...
    public enum DividerType { // 分隔线类型
        FILL, WRAP, CIRCLE, LEFT_ROUND, RIGHT_ROUND, ROUND
    }
    ...
    public DividerType getLeftDividerType() {
        return dividerTypeLeft;
    }

    public DividerType getRightDividerType() {
        return dividerTypeRitht;
    }
    ...
    public void setLeftDividerType(DividerType dividerType) {
        this.dividerTypeLeft = dividerType;
    }

    public void setRightDividerType(DividerType dividerType) {
        this.dividerTypeRitht = dividerType;
    }

    private DividerType dividerType = DividerType.WRAP;
    private DividerType dividerTypeLeft = DividerType.WRAP;
    private DividerType dividerTypeRitht = DividerType.WRAP;
