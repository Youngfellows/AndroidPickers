...
//    }
    ...
    public void setDividerType(LineConfig.DividerType dividerType) {
        ...
        lineConfig.setDividerType(dividerType);
    }
     ...
     * @param dividerType 分割线类型
     */
    public void setLeftDividerType(LineConfig.DividerType dividerType) {
        if (null == lineConfig) {
            lineConfig = new LineConfig();
        }
        lineConfig.setLeftDividerType(dividerType);
    }
     ...
     * @param dividerType 分割线类型
     */
    public void setRightDividerType(LineConfig.DividerType dividerType) {
        if (null == lineConfig) {
            lineConfig = new LineConfig();
        }
        lineConfig.setRightDividerType(dividerType);
    }
